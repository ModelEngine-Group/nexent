...
::: info 截图待补充
**截图内容**：普通用户知识库列表底部的个人容量条，分别展示有限配额和无限制状态中的一种。

**建议文件**：`doc/docs/zh/user-guide/assets/knowledge-base/personal-kb-capacity.png`
:::
...
::: info 截图待补充
**截图内容**：文档列表同时展示处理中进度和失败状态的错误原因、排查建议。

**建议文件**：`doc/docs/zh/user-guide/assets/knowledge-base/document-processing-status.png`
:::
...
::: info 截图待补充
**截图内容**：Chunk 详情页，包含文档标签、搜索、分片卡片、创建/编辑/下载/删除按钮和分页器。

**建议文件**：`doc/docs/zh/user-guide/assets/knowledge-base/chunk-management.png`
:::
