...
> **Note**: Deleted conversations usually cannot be recovered. Confirm the operation before deleting a conversation.
...
- **View the document content**: Preview the generated document directly in the conversation area.
...
- **Download the document**: Click the download button to save it locally.
