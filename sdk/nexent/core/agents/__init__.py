...
_EXPORTS = {
    ...
    "TurnResourcesComponent": (_AGENT_MODEL_MODULE, "TurnResourcesComponent"),
    "TurnResourceInvocation": (".turn_resources", "TurnResourceInvocation"),
    "ResolvedTurnResource": (".turn_resources", "ResolvedTurnResource"),
