    ...
    def forward(
        ...
        try:
            ...
            if not knowledge_base_ids:
                # No specific knowledge bases provided, get all available knowledge bases
                kb_list = self.datamate_core.client.list_knowledge_bases(
                    page=self.kb_page, size=self.kb_page_size)
                knowledge_base_ids = [kb.get('id') for kb in kb_list]
                if not knowledge_base_ids:
