...
MIGRATION = ROOT / "deploy/sql/migrations/v2.5.0_0824_context_budget_p1_governance.sql"


def test_ac_p1_011_governance_migration_is_nullable_idempotent_and_secret_free():
