...
MIGRATION = ROOT / "deploy/sql/migrations/v2.5.0_0824_context_budget_p3_observability.sql"


def test_ac_p3_006_observability_migration_is_nullable_idempotent_and_content_free():
