...
with patch('botocore.client.BaseClient._make_api_call'), \
    ...
    from backend.management.services.knowledge_base.service import ElasticSearchService, check_knowledge_base_exist_impl, KnowledgeBaseNeedsModelConfigError
...
class TestElasticSearchService(unittest.TestCase):
    def setUp(self):
        ...
        self.get_embedding_model_patcher = patch(
            'backend.management.services.knowledge_base.service.get_embedding_model')
        ...
        self.get_embedding_model_by_id_patcher = patch(
            'backend.management.services.knowledge_base.service.get_embedding_model_by_id')
        ...
        self.get_model_by_id_patcher = patch(
            'backend.management.services.knowledge_base.service.get_model_by_model_id')
        ...
        self.get_rerank_model_patcher = patch(
            'backend.management.services.knowledge_base.service.get_rerank_model')
    ...
    @patch('backend.management.services.knowledge_base.service.create_knowledge_record')
    ...
    @patch('backend.management.services.knowledge_base.service.get_embedding_model')
    @patch('backend.management.services.knowledge_base.service.create_knowledge_record')
    ...
    @patch(
        'backend.management.services.knowledge_base.service.create_knowledge_record',
    ...
    @patch('backend.management.services.knowledge_base.service.delete_knowledge_record')
    ...
    @patch('backend.management.services.knowledge_base.service.query_group_ids_by_user')
    @patch('backend.management.services.knowledge_base.service.get_user_tenant_by_user_id')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_info_by_tenant_id')
    ...
    @patch('backend.management.services.knowledge_base.service.query_group_ids_by_user')
    @patch('backend.management.services.knowledge_base.service.get_user_tenant_by_user_id')
    @patch('backend.management.services.knowledge_base.service.update_model_name_by_index_name')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_info_by_tenant_id')
    ...
    @patch('backend.management.services.knowledge_base.service.get_user_tenant_by_user_id')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_info_by_tenant_id')
    @patch('backend.management.services.knowledge_base.service.IS_SPEED_MODE', new=False)
    ...
    def test_list_indices_fallback_admin_logic(self, mock_get_knowledge, mock_get_user_tenant, mock_get_group_ids):
        ...
        # Execute
        with patch('backend.management.services.knowledge_base.service.logger') as mock_logger:
            result = ElasticSearchService.list_indices(
                pattern="*",
                include_stats=True,  # Need stats to see permissions
    ...
    def test_vectorize_documents_success(self):
        ...
        with patch('backend.management.services.knowledge_base.service.get_knowledge_record') as mock_get_record, \
                patch('backend.management.services.knowledge_base.service.tenant_config_manager') as mock_tenant_cfg, \
                patch('backend.management.services.knowledge_base.service.update_last_doc_update_time'):
    ...
    def test_index_documents_fetches_image_bytes(self):
        ...
        with patch('backend.management.services.knowledge_base.service.get_knowledge_record') as mock_get_record, \
                patch('backend.management.services.knowledge_base.service.tenant_config_manager') as mock_tenant_cfg, \
                patch('backend.management.services.knowledge_base.service.get_file_stream') as mock_get_stream, \
                patch('backend.management.services.knowledge_base.service.update_last_doc_update_time'):
            mock_get_record.return_value = {
                "tenant_id": consts_const_mod.DEFAULT_TENANT_ID}
            mock_tenant_cfg.get_model_config.return_value = {"chunk_batch": 5}
    ...
    def test_vectorize_documents_create_index(self):
        ...
        # Execute
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.create_index') as mock_create_index, \
                patch('backend.management.services.knowledge_base.service.get_knowledge_record') as mock_get_record, \
                patch('backend.management.services.knowledge_base.service.tenant_config_manager') as mock_tenant_cfg, \
                patch('backend.management.services.knowledge_base.service.update_last_doc_update_time'):
    ...
    @patch('backend.management.services.knowledge_base.service.get_all_files_status')
    ...
    @patch('backend.management.services.knowledge_base.service.get_redis_service')
    @patch('backend.management.services.knowledge_base.service.get_file_size', return_value=12)
    @patch('backend.management.services.knowledge_base.service.list_file_records')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    @patch('backend.management.services.knowledge_base.service.get_all_files_status', new_callable=AsyncMock)
    ...
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    @patch('backend.management.services.knowledge_base.service.get_file_record')
    @patch('backend.management.services.knowledge_base.service.transition_file_record')
    ...
    @patch('backend.management.services.knowledge_base.service.create_delete_tombstone')
    @patch('backend.management.services.knowledge_base.service.get_file_record', return_value=None)
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    ...
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record', return_value={})
    ...
    @patch('backend.management.services.knowledge_base.service.get_file_record')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record', return_value={"tenant_id": "tenant-1"})
    @patch('backend.management.services.knowledge_base.service.delete_file_record')
    ...
    @patch('backend.management.services.knowledge_base.service.delete_file_record', return_value=True)
    @patch('backend.management.services.knowledge_base.service.transition_file_record')
    ...
    @patch(
        'backend.management.services.knowledge_base.service.get_file_record',
        side_effect=[{"status": "DELETED"}, None],
    )
    @patch('backend.management.services.knowledge_base.service.delete_file_record', return_value=False)
    @patch('backend.management.services.knowledge_base.service.transition_file_record', return_value=None)
    ...
    @patch('backend.management.services.knowledge_base.service.get_file_record', return_value={"status": "DELETED"})
    @patch('backend.management.services.knowledge_base.service.delete_file_record', return_value=True)
    @patch('backend.management.services.knowledge_base.service.transition_file_record', return_value=None)
    ...
    @patch('backend.management.services.knowledge_base.service.get_file_record', return_value={"status": "FAILED"})
    @patch('backend.management.services.knowledge_base.service.delete_file_record', return_value=False)
    @patch('backend.management.services.knowledge_base.service.transition_file_record', return_value=None)
    ...
    @patch('backend.management.services.knowledge_base.service.update_last_doc_update_time')
    @patch('backend.management.services.knowledge_base.service.delete_file')
    ...
    @patch('backend.management.services.knowledge_base.service.delete_file')
    @patch('backend.management.services.knowledge_base.service.file_exists', return_value=False)
    ...
    @patch('backend.management.services.knowledge_base.service.release_storage_charge')
    @patch('backend.management.services.knowledge_base.service.resolve_storage_reference')
    @patch('backend.management.services.knowledge_base.service.file_exists', return_value=False)
    @patch('backend.management.services.knowledge_base.service.delete_file')
    ...
    @patch(
        'backend.management.services.knowledge_base.service.get_all_files_status',
    ...
    @patch.object(ElasticSearchService, "_mark_file_deleted")
    @patch.object(
        ElasticSearchService,
        "delete_documents",
        return_value={"status": "success", "deleted_minio": True},
    )
    @patch.object(ElasticSearchService, "_mark_file_delete_requested")
    ...
    @patch(
        'backend.management.services.knowledge_base.service.get_knowledge_record',
    ...
    def test_full_document_delete_keeps_charge_when_minio_fails(
        ...
        with patch(
            'backend.management.services.knowledge_base.service.update_last_doc_update_time'
        ):
            result = ElasticSearchService.delete_documents(
    ...
    @patch('backend.management.services.knowledge_base.service.resolve_storage_reference')
    @patch('backend.management.services.knowledge_base.service.delete_file')
    @patch('backend.management.services.knowledge_base.service.list_committed_storage_objects')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    def test_kb_source_cleanup_uses_canonical_union_and_preserves_failed_charge(
        ...
        with patch(
            'backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
            new_callable=AsyncMock,
            return_value={
                "files": [
    ...
    def test_delete_index_skips_duplicate_source_cleanup(self):
        from backend.management.services.knowledge_base.service import _SKIP_INDEX_SOURCE_CLEANUP
        ...
        try:
            with patch(
                'backend.management.services.knowledge_base.service.ElasticSearchService._delete_kb_source_objects',
                cleanup,
            ), patch(
                'backend.management.services.knowledge_base.service.delete_knowledge_record',
                return_value=True,
            ):
                result = asyncio.run(
    ...
    def test_index_documents_respects_cancellation_flag(self, mock_get_redis_service, mock_update_last_doc):
        ...
        with patch('backend.management.services.knowledge_base.service.get_knowledge_record') as mock_get_record:
            mock_get_record.return_value = {"tenant_id": "tenant-1"}
            with patch('backend.management.services.knowledge_base.service.tenant_config_manager') as mock_tenant_cfg:
                mock_tenant_cfg.get_model_config.return_value = {
                    "chunk_batch": 10}
    ...
    @patch('backend.management.services.knowledge_base.service.get_embedding_model_by_index_name')
    ...
    def test_summary_index_name_runtime_error_fallback(self):
        ...
        with patch('backend.utils.document_vector_utils.process_documents_for_clustering') as mock_process_docs, \
            ...
            with patch('backend.management.services.knowledge_base.service.asyncio.get_running_loop',
                       side_effect=RuntimeError("No running event loop")), \
                    patch('backend.management.services.knowledge_base.service.asyncio.get_event_loop',
    ...
    @patch('backend.management.services.knowledge_base.service.update_last_summary_time')
    @patch('backend.management.services.knowledge_base.service.update_knowledge_record')
    ...
    def test_update_knowledge_base_empty_group_ids(self):
        ...
        """
        with patch('backend.management.services.knowledge_base.service.update_knowledge_record') as mock_update:
    ...
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    @patch('backend.management.services.knowledge_base.service.get_embedding_model_by_id')
    ...
    @patch('backend.management.services.knowledge_base.service.update_last_doc_update_time')
    @patch('backend.management.services.knowledge_base.service.tenant_config_manager')
    @patch('backend.management.services.knowledge_base.service.get_knowledge_record')
    ...
    def test_get_vdb_core(self):
        ...
        """
        from backend.management.services.knowledge_base.service import get_vector_db_core
    ...
    def test_update_progress_success(self, mock_get_redis):
        ...
        from backend.management.services.knowledge_base.service import _update_progress
...
class TestRethrowOrPlain(unittest.TestCase):
    ...
    def test_rethrow_or_plain_rethrows_json_error_code(self):
        ...
        from backend.management.services.knowledge_base.service import _rethrow_or_plain
    ...
    @patch('backend.management.services.knowledge_base.service.tenant_config_manager')
    @patch('backend.management.services.knowledge_base.service.DataMateCore')
    ...
    def test_full_delete_knowledge_base_no_files_redis_warning(self, mock_get_redis):
        ...
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
                   new_callable=AsyncMock, return_value={"files": []}) as mock_list_files, \
                patch('backend.management.services.knowledge_base.service.ElasticSearchService.delete_index',
    ...
    def test_full_delete_knowledge_base_minio_and_redis_error(self, mock_get_redis):
        ...
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
                ...
                patch('backend.management.services.knowledge_base.service.delete_file') as mock_delete_file, \
                patch('backend.management.services.knowledge_base.service.ElasticSearchService.delete_index',
                      new_callable=AsyncMock, return_value={"status": "success"}) as mock_delete_index:
            mock_delete_file.side_effect = [
                {"success": True},
    ...
    @patch('backend.management.services.knowledge_base.service.get_embedding_model')
    @patch('backend.management.services.knowledge_base.service.get_model_by_model_id')
    @patch('backend.management.services.knowledge_base.service.create_knowledge_record')
    ...
    @patch('backend.management.services.knowledge_base.service.get_all_files_status', return_value={})
    ...
    @patch('backend.management.services.knowledge_base.service.get_model_records')
    @patch('backend.management.services.knowledge_base.service.tenant_config_manager')
    def test_get_rerank_model_with_specific_model_name_found(
        ...
        try:
            with patch('backend.management.services.knowledge_base.service.build_adapter_fresh') as mock_build:
                mock_adapter = MagicMock()
                mock_build.return_value = mock_adapter

                # Execute
                from backend.management.services.knowledge_base.service import get_rerank_model
    ...
    def test_create_chunk_embedding_exception_without_explicit_model_is_tolerated(
        ...
        from backend.management.services.knowledge_base.service import ChunkCreateRequest
    ...
    def test_update_chunk_minimal_payload_still_updates(self, mock_get_knowledge_record):
        ...
        from backend.management.services.knowledge_base.service import ChunkUpdateRequest
...
class TestNewEmbeddingModelMethods(unittest.TestCase):
    ...
    def test_get_embedding_model_display_name_with_none_model_id(self, mock_get_model):
        ...
        """
        from backend.management.services.knowledge_base.service import _get_embedding_model_display_name
    ...
    def test_get_embedding_model_by_index_name_kb_not_found(self, mock_get_knowledge):
        ...
        """
        from backend.management.services.knowledge_base.service import get_embedding_model_by_index_name
    ...
    @patch('backend.management.services.knowledge_base.service.get_model_by_model_id')
    @patch('backend.management.services.knowledge_base.service.build_adapter_fresh')
    def test_get_embedding_model_by_id_embedding_type(self, mock_build, mock_get_model):
        ...
        """
        from backend.management.services.knowledge_base.service import get_embedding_model_by_id
    ...
    @patch('backend.management.services.knowledge_base.service.update_embedding_model_by_index_name')
    @patch('backend.management.services.knowledge_base.service.get_model_by_model_id')
...
class TestCoverageImprovement(unittest.TestCase):
    ...
    async def test_list_files_file_count_exception(self):
        ...
        with patch('backend.management.services.knowledge_base.service.get_all_files_status',
    ...
    def test_search_hybrid_needs_model_config_error(self, mock_get_model):
        ...
        from backend.management.services.knowledge_base.service import (
    ...
    async def test_delete_index_list_files_exception_continues(self):
        ...
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
                ...
                patch('backend.management.services.knowledge_base.service.delete_knowledge_record', return_value=True):
            result = await ElasticSearchService.delete_index(
                index_name="test-index",
                vdb_core=self.mock_vdb_core,
                user_id="user-1",
    ...
    @patch('backend.management.services.knowledge_base.service.ElasticSearchService.create_index')
    ...
    def test_create_chunk_knowledge_record_exception(self, mock_get_record):
        ...
        self.mock_vdb_core.create_chunk.return_value = {"id": "chunk-1"}
        from consts.model import ChunkCreateRequest
        with patch('backend.management.services.knowledge_base.service.get_embedding_model_by_id',
    ...
    def test_is_multimodal_by_model_id_exception(self):
        ...
        from backend.management.services.knowledge_base.service import _is_multimodal_by_model_id
        with patch('backend.management.services.knowledge_base.service.get_model_by_model_id',
    ...
    def test_normalize_model_type_embedding(self):
        ...
        from backend.management.services.knowledge_base.service import _normalize_model_type
    ...
    def test_create_embedding_model_dashscope(self):
        ...
        from backend.management.services.knowledge_base.service import _create_embedding_model
        with patch('backend.management.services.knowledge_base.service.build_adapter_fresh') as mock_build:
            mock_adapter = MagicMock()
            mock_build.return_value = mock_adapter
    ...
    async def test_delete_index_with_minio_files(self):
        ...
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
                ...
                patch('backend.management.services.knowledge_base.service.delete_file', mock_delete_file), \
                patch('backend.management.services.knowledge_base.service.delete_knowledge_record', return_value=True):
            result = await ElasticSearchService.delete_index(
                index_name="test-index",
                vdb_core=self.mock_vdb_core,
    ...
    async def test_delete_index_minio_deletion_error_logs_and_continues(self):
        ...
        with patch('backend.management.services.knowledge_base.service.ElasticSearchService.list_files',
                ...
                patch('backend.management.services.knowledge_base.service.delete_knowledge_record', return_value=True), \
                patch('backend.management.services.knowledge_base.service.logger') as mock_logger:
            result = await ElasticSearchService.delete_index(
                index_name="test-index",
                vdb_core=self.mock_vdb_core,
                user_id="user-1",
    ...
    @patch('backend.management.services.knowledge_base.service.get_knowledge_info_by_tenant_id')
    @patch('backend.management.services.knowledge_base.service.update_model_name_by_index_name')
    @patch('backend.management.services.knowledge_base.service.ASSET_OWNER_TENANT_ID', new="asset_owner_tenant_id")
    ...
    def test_index_documents_skips_non_dict_items(self, mock_update_last_doc):
        ...
        with patch('backend.management.services.knowledge_base.service.get_knowledge_record',
                   return_value={"tenant_id": "tenant-1"}), \
                patch('backend.management.services.knowledge_base.service.tenant_config_manager') as mock_tcm:
    ...
    @patch('backend.management.services.knowledge_base.service.get_file_stream')
    def test_index_documents_image_fetch_exception_and_raise(self, mock_get_file):
        ...
        with patch('backend.management.services.knowledge_base.service.get_knowledge_record',
                   return_value={"tenant_id": "tenant-1"}), \
                patch('backend.management.services.knowledge_base.service.tenant_config_manager.get_model_config',
    ...
    async def test_list_files_file_size_exception(self):
        ...
        with patch('backend.management.services.knowledge_base.service.get_all_files_status', mock_get_files), \
                patch('backend.management.services.knowledge_base.service.get_file_size',
    ...
    async def test_list_files_redis_error_info_exception(self):
        ...
        with patch('backend.management.services.knowledge_base.service.get_all_files_status', mock_get_files), \
                patch('backend.management.services.knowledge_base.service.get_redis_service') as mock_get_redis:
...
def _patch_kb_permission_context(
    ...
    import backend.management.services.knowledge_base.service as vdb_service
...
def test_resolve_knowledge_base_permission_speed_mode_uses_record_tenant_when_user_has_no_tenant(
    ...
    monkeypatch.setattr(
        "backend.management.services.knowledge_base.service.ResourceAccessControl.check",
...
def test_create_knowledge_base_forces_user_to_private_without_groups(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.management.services.knowledge_base.service._create_embedding_model",
