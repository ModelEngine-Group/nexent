...
# Mock database.agent_db — imported by recipe_service as `from database.agent_db import query_all_agent_info_by_tenant_id`
agent_db_mock = MagicMock()
agent_db_mock.query_all_agent_info_by_tenant_id = MagicMock()
sys.modules.setdefault('database.agent_db', agent_db_mock)
