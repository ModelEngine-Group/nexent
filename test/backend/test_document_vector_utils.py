...
class TestKMeansClustering:
    ...
    def test_kmeans_cluster_documents_single_document(self):
        """Test handling of single document - should skip clustering"""
        doc_embeddings = {
        ...
        # Should return a single cluster with the document
