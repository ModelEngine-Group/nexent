...
def test_get_groups_by_tenant_success(monkeypatch, mock_session):
    ...
    result = get_groups_by_tenant("test_tenant")
...
def test_soft_delete_group_success(monkeypatch, mock_session):
    ...
    result = soft_delete_group(group_id=123, updated_by="test_user")
...
def test_get_user_groups_success(monkeypatch, mock_session):
...
def test_is_user_in_group_true(monkeypatch, mock_session):
    ...
    result = is_user_in_group("test_user", 123)
