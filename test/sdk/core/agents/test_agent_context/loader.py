...
def _register_stub_packages():
    """Create parent ModuleType entries with __path__ so sub-package import works.
...
# Finally, create the agent_context package module that re-exports public names
...
_ctx_mod.ContextManagerConfig  = _manager_mod.ContextManagerConfig  # from summary_config
