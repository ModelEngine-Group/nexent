...
def test_p8_feature_resolution_is_emitted_as_sanitized_span_attributes(
    ...
    assert feature_attributes == {
        ...
        "llm.feature.configuration_warnings": "",
...
def test_p8_tenant_feature_policy_and_warning_are_traced(openai_model_instance):
    openai_model_instance.feature_capabilities = {
        "reasoning": {
            "supported": True,
            "mode": "toggle",
    ...
    openai_model_instance.feature_preferences = {
        "reasoning": {"enabled": False}
    }
    openai_model_instance.feature_configuration_warnings = [
    ...
    assert attributes["llm.reasoning.effective_enabled"] is False
    assert attributes["llm.feature.policy_source"] == "model_record_override"
    assert (
        attributes["llm.feature.configuration_warnings"]
        == "override_identity_mismatch"
    )
