...
# without exposing httpx_client_factory, so it would reject self-signed/internal
# MCP servers. The config/scan path already disables verify (create_httpx_client);
# mirror that here. verify=False only relaxes checks, never breaks a connection.
