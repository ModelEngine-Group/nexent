...
export const LAYOUT = {
  ...
  ACTION_TEXT: "text-red-500 hover:text-red-700 font-medium text-xs", // Delete button text style (danger action)
  PREVIEW_TEXT: "text-blue-500 hover:text-blue-700 font-medium text-xs", // Preview button text style
};
