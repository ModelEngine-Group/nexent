    ...
    <>
      ...
      <div className="mb-4 mt-10">
        <div className="flex flex-wrap gap-2 justify-center">
          <button
            onClick={() => onInputChange(t("chatInput.exampleTag1"))}
            className="px-4 py-2 rounded-full bg-white border border-slate-200 text-sm text-slate-700 hover:border-slate-400 hover:shadow-sm transition-all"
          >
            {t("chatInput.exampleTag1")}
          </button>
          <button
            onClick={() => onInputChange(t("chatInput.exampleTag2"))}
            className="px-4 py-2 rounded-full bg-white border border-slate-200 text-sm text-slate-700 hover:border-slate-400 hover:shadow-sm transition-all"
          >
            {t("chatInput.exampleTag2")}
          </button>
          <button
            onClick={() => onInputChange(t("chatInput.exampleTag3"))}
            className="px-4 py-2 rounded-full bg-white border border-slate-200 text-sm text-slate-700 hover:border-slate-400 hover:shadow-sm transition-all"
          >
            {t("chatInput.exampleTag3")}
          </button>
        </div>
      </div>: <div></div>}
    </>
