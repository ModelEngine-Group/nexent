...
interface UseOrcaRouterModelListProps {
  form: {
    type: ModelType;
    isBatchImport: boolean;
    apiKey: string;
    provider: string; // Expected to be "orcarouter"
    maxTokens: string;
...
export const useOrcaRouterModelList = ({
  form,
  setModelList,
  setSelectedModelIds,
  setShowModelList,
