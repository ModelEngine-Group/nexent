...
export function TopNavbar({ isChatPage }: { isChatPage: boolean }) {
    ...
    <Flex align="center">
      ...
      >
        <Flex align="center" gap={8}>
          <img src="/hnsrmyy_logo2.png" alt="ModelEngine" className="h-7" />
          <span
            className="font-hospital-title text-slate-900 dark:text-white"
            style={{
              fontSize: "20px",
              lineHeight: "24px",
              height: "22px",
  ...
  const rightContent = (
    <Flex align="center" gap={16} className="hidden md:flex">
      ...
      {/* GitHub link - hidden via branding */}
      ...
      {/* ModelEngine link - hidden via branding */}
      <div className="hidden">
        <Link
