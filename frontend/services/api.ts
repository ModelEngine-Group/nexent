...
export const API_ENDPOINTS = {
  ...
  model: {
    ...
    manageCapacityAdoptionPreview: `${API_BASE_URL}/model/manage/capacity-adoption-preview`,
    manageCapacityAdopt: `${API_BASE_URL}/model/manage/capacity-adopt`,
    manageTokenCountProbe: `${API_BASE_URL}/model/manage/token-count-probe`,
