...
export const fetchWithErrorHandling = async (
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        const parsedErrorData = JSON.parse(errorText);
        const errorDetail =
          parsedErrorData?.detail && typeof parsedErrorData.detail === "object"
            ? parsedErrorData.detail
            : parsedErrorData?.message && typeof parsedErrorData.message === "object"
        ...
        } else if (typeof parsedErrorData?.detail === "string") {
          errorMessage = parsedErrorData.detail;
        } else if (typeof parsedErrorData?.message === "string") {
