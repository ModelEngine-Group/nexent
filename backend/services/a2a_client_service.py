...
class A2AClientService:
    ...
    async def check_agent_health(
        ...
        try:
            ...
            async with A2AHttpClient(timeout=10.0) as client:
                await client.get_json(agent_url)
            ...
            return {"status": "ok", "agent_id": external_agent_id}
            ...
            return {"status": "timeout", "agent_id": external_agent_id, "message": "Connection timeout"}
