...
async def _create_datamate_knowledge_records(knowledge_base_ids: List[str],
    ...
    for i, kb_id in enumerate(knowledge_base_ids):
        try:
            ...
            knowledge_name = knowledge_base_names[i] if i < len(knowledge_base_names) else kb_id
            ...
            record_data = {
                ...
                "tenant_id": tenant_id,
                "user_id": user_id,
                "embedding_model_name": embedding_model_names[i]  # Use datamate as embedding model name
            }
