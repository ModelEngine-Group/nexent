...
def get_cas_config() -> Dict[str, Any]:
    ...
    return {
        "enabled": enabled,
        "login_mode": mode,
        "heartbeat_url": CAS_HEARTBEAT_URL,
        "heartbeat_interval_seconds": CAS_HEARTBEAT_INTERVAL_SECONDS,
        "heartbeat_cookie_name": CAS_HEARTBEAT_COOKIE_NAME,
        "renew_enabled": CAS_RENEW_ENABLED,
