...
class QuotaService:
    ...
    def set_warning_config(
        ...
        # A warning threshold at or above the critical threshold would make the
        # warning level unreachable or semantically inverted; reject the pair
        # against whichever values will be effective after this update.
        effective_warning = (
            warning_pct
            if warning_pct is not None
