...
KNOWLEDGE_SPAN_DESCRIPTIONS = {
    ...
    "knowledge.process.split_and_prefork": "判断是否拆分文件，并向 Celery prefork 子任务分发解析工作。",
    "knowledge.process.prefork_dispatch": "向 Celery prefork 子进程分发解析分片。",
    "knowledge.process.prefork_split": "在解析子进程内执行大文件拆分。",
    ...
    "knowledge.process.parser_child": "在独立 Celery prefork 子进程内执行文档预处理。",
