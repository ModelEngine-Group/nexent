...
try:
    from consts.const import (
        ...
        MONITORING_INSTRUMENT_FASTAPI_RAW,
        MONITORING_INSTRUMENT_FASTAPI,
        MONITORING_INSTRUMENT_REQUESTS_RAW,
...
def _build_env_overrides() -> dict:
    ...
    if MONITORING_INSTRUMENT_FASTAPI_RAW is not None:
        overrides["instrument_fastapi"] = MONITORING_INSTRUMENT_FASTAPI
    if MONITORING_INSTRUMENT_REQUESTS_RAW is not None:
        overrides["instrument_requests"] = MONITORING_INSTRUMENT_REQUESTS
    if MONITORING_FASTAPI_EXCLUDED_URLS:
        overrides["fastapi_excluded_urls"] = MONITORING_FASTAPI_EXCLUDED_URLS
    if MONITORING_FASTAPI_EXCLUDE_SPANS:
        overrides["fastapi_exclude_spans"] = MONITORING_FASTAPI_EXCLUDE_SPANS
