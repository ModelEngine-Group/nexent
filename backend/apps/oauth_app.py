...
async def callback(
    ...
    if error:
        record_security_event("oauth_login", AUDIT_RESULT_FAILURE, request=request,
    ...
    try:
        ...
        record_security_event("oauth_login", AUDIT_RESULT_SUCCESS, request=request,
...
async def complete(
    ...
    try:
        ...
        record_security_event("oauth_signup", AUDIT_RESULT_SUCCESS, request=request,
...
async def delete_account(
    ...
    try:
        ...
        record_security_event("oauth_unlink", AUDIT_RESULT_SUCCESS, request=request,
        ...
        record_security_event("oauth_unlink", AUDIT_RESULT_FAILURE, request=request,
