from sqlalchemy import BigInteger, Boolean, Column, Float, ForeignKey, ForeignKeyConstraint, Index, Integer, JSON, Numeric, PrimaryKeyConstraint, Sequence, String, Text, TIMESTAMP, UniqueConstraint
...
class ModelMonitoringRecord(SimpleTableBase):
    ...
    Uses SimpleTableBase to avoid audit fields (created_by, updated_by).
    """
