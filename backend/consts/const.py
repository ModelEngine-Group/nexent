...
DREAMING_COMPRESSION_BACKOFF_BASE_SECONDS = float(os.getenv("DREAMING_COMPRESSION_BACKOFF_BASE_SECONDS", "1.0"))
DREAMING_COMPRESSION_PHASE_TIMEOUT_SECONDS = int(os.getenv("DREAMING_COMPRESSION_PHASE_TIMEOUT_SECONDS", "300"))
