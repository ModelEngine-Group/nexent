...
RUNTIME_AGENT_THREAD_MAX_WORKERS = int(os.getenv("RUNTIME_AGENT_THREAD_MAX_WORKERS", "8"))
...
RUNTIME_MCP_TOOL_TIMEOUT_SECONDS = float(
    os.getenv("RUNTIME_MCP_TOOL_TIMEOUT_SECONDS", "120")
)
RUNTIME_MCP_CLOSE_TIMEOUT_SECONDS = float(
    os.getenv("RUNTIME_MCP_CLOSE_TIMEOUT_SECONDS", "5")
)
if RUNTIME_MCP_TOOL_TIMEOUT_SECONDS <= 0 or RUNTIME_MCP_CLOSE_TIMEOUT_SECONDS <= 0:
    raise ValueError("Runtime MCP timeouts must be greater than zero")
