...
MONITORING_CONFIG_FILE = os.getenv("MONITORING_CONFIG_FILE", "")
...
MONITORING_USE_PLATFORM_SDK_RAW = os.getenv("MONITORING_USE_PLATFORM_SDK")
MONITORING_USE_PLATFORM_SDK = (MONITORING_USE_PLATFORM_SDK_RAW or "false").lower() == "true"
...
LLM_SLOW_REQUEST_THRESHOLD_SECONDS_RAW = os.getenv("LLM_SLOW_REQUEST_THRESHOLD_SECONDS")
LLM_SLOW_REQUEST_THRESHOLD_SECONDS = float(
    LLM_SLOW_REQUEST_THRESHOLD_SECONDS_RAW or "5.0")
LLM_SLOW_TOKEN_RATE_THRESHOLD_RAW = os.getenv("LLM_SLOW_TOKEN_RATE_THRESHOLD")
LLM_SLOW_TOKEN_RATE_THRESHOLD = float(
    LLM_SLOW_TOKEN_RATE_THRESHOLD_RAW or "10.0")
