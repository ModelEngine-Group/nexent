...
NL2AGENT_ACTIVE_RETENTION_DAYS = max(
    1, int(os.getenv("NL2AGENT_ACTIVE_RETENTION_DAYS", "30"))
)
NL2AGENT_COMPLETED_RETENTION_DAYS = max(
    1, int(os.getenv("NL2AGENT_COMPLETED_RETENTION_DAYS", "30"))
)
