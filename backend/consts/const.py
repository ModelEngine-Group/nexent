...
KB_FILE_LIFECYCLE_RETENTION_DAYS = int(
    os.getenv("KB_FILE_LIFECYCLE_RETENTION_DAYS", "30"))
KB_FILE_LIFECYCLE_CLEANUP_INTERVAL_SECONDS = int(
    os.getenv("KB_FILE_LIFECYCLE_CLEANUP_INTERVAL_SECONDS", "3600"))
