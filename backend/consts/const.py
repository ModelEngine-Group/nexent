...
MAX_DATA_PROCESS_FILE_SIZE_BYTES = int(
    os.getenv("DP_MAX_FILE_SIZE_BYTES", str(50 * 1024 * 1024)))
MAX_CHUNKS_PER_FILE = int(os.getenv("DP_MAX_CHUNKS_PER_FILE", "10000"))
DP_RAY_OPERATION_TIMEOUT_S = int(
    os.getenv("DP_RAY_OPERATION_TIMEOUT_S", "300"))
DP_FORWARD_REQUEST_TIMEOUT_S = int(
    os.getenv("DP_FORWARD_REQUEST_TIMEOUT_S", "300"))
DP_FORWARD_FILE_TIMEOUT_S = int(
    os.getenv("DP_FORWARD_FILE_TIMEOUT_S", "1800"))
DP_INGESTION_QUEUE_TIMEOUT_S = int(
    os.getenv("DP_INGESTION_QUEUE_TIMEOUT_S", "1800"))
DP_INGESTION_FINALIZATION_TIMEOUT_S = int(
    os.getenv("DP_INGESTION_FINALIZATION_TIMEOUT_S", "60"))
DP_INGESTION_WATCHDOG_INTERVAL_S = int(
    os.getenv("DP_INGESTION_WATCHDOG_INTERVAL_S", "10"))
DP_SPLIT_STATE_TTL_S = int(os.getenv("DP_SPLIT_STATE_TTL_S", "7200"))
...
MINIO_CONNECT_TIMEOUT_S = int(os.getenv("MINIO_CONNECT_TIMEOUT_S", "10"))
MINIO_READ_TIMEOUT_S = int(os.getenv("MINIO_READ_TIMEOUT_S", "60"))
...
CELERY_RESULT_EXPIRES = int(os.getenv("CELERY_RESULT_EXPIRES", str(7 * 24 * 60 * 60)))
