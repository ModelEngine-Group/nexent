...
RUNTIME_SERVICE_URL = os.getenv("RUNTIME_SERVICE_URL", "http://127.0.0.1:5014").rstrip("/")
...
POSTGRES_MAX_OVERFLOW = int(os.getenv("POSTGRES_MAX_OVERFLOW", "5"))
POSTGRES_POOL_TIMEOUT_SECONDS = int(os.getenv("POSTGRES_POOL_TIMEOUT_SECONDS", "30"))
POSTGRES_POOL_RECYCLE_SECONDS = int(os.getenv("POSTGRES_POOL_RECYCLE_SECONDS", "1800"))
...
RUNTIME_RUN_TTL_SECONDS = int(os.getenv("RUNTIME_RUN_TTL_SECONDS", "60"))
RUNTIME_HEARTBEAT_INTERVAL_SECONDS = float(os.getenv("RUNTIME_HEARTBEAT_INTERVAL_SECONDS", "15"))
RUNTIME_CANCEL_TTL_SECONDS = int(os.getenv("RUNTIME_CANCEL_TTL_SECONDS", "60"))
