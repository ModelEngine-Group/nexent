...
class ModelRequest(BaseModel):
    ...
    feature_capability_override: Optional[Dict[str, Any]] = None
...
class ManageTenantModelCreateRequest(BaseModel):
    ...
    feature_capability_override: Optional[Dict[str, Any]] = Field(
        None, description="Tenant-model feature capability and policy override"
    )
